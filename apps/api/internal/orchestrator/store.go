...
// dbStore implements Store over the request + workflow repos.
type dbStore struct {
...
func NewDBStore(requests *repo.RequestRepo, workflow *repo.WorkflowRepo) Store {
	return &dbStore{requests: requests, workflow: workflow}
}
