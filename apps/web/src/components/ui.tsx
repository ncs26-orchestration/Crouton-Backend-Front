...
export function PageHeader({
  ...
  return (
    <div className="border-b border-[var(--color-border)] px-4 md:px-8 py-4 md:py-5 flex flex-col md:flex-row md:items-start md:justify-between gap-3 md:gap-4 shrink-0">
