...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-B6Qm3T2O.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CsM1f2bp.mjs"),
		import("./start-UvjF58Bu.mjs"),
		import("./empty-plugin-adapters-BcFVfNOI.mjs")
	]);
	return {
		routerEntry,
		startEntry,
